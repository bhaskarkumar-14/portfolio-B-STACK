...
const testimonials = [
    {
        ...
        name: "Sarah Johnson",
        role: "CTO, TechFlow",
        content: "The team transformed our outdated platform into a cutting-edge web application. The attention to detail and performance optimization was outstanding.",
    ...
    },
    {
        ...
        content: "Incredible design sense combined with robust engineering. They didn't just build what we asked for; they improved upon our original vision.",
    ...
    },
    {
        ...
        content: "Reliable, communicative, and extremely talented. The new website has increased our conversion rates by 40% in just two months.",
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-10 relative z-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((testimonial, index) => (
                        ...
                        >
                            <Quote className="absolute top-8 right-8 w-10 h-10 text-white/5 group-hover:text-primary/10 transition-colors" />
